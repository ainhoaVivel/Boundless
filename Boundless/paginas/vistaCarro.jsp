...
<html>
    ...
    <meta name="descripcion" content="Contiene información sobre los productos seleccionados para compra">
...
<!--Menú de navegación-->
    ...
    <div class="seccion w3-animate-opacity" style="margin: 0em; padding-top: 0em;padding-bottom: 0em;">
        <h3 style="margin-left: 1em; margin-top: 1em; margin-bottom: 1em; font-weight:600;">Carrito de la compra</h3>
    </div>
    <center>
    <div class="w3-animate-opacity">
                    ...
                    <c:forEach var="mercancia" items="${carro}">
                        <tr>
                            ...
                            <td style="text-align: center ">
                                <c:choose>
                                    <c:when test="${!empty param.stockMax && mercancia.descripcion ==  param.mercanciaString}">
                            ...
                            <td>
                                <center>
                                    <input type="radio" name="descripcionMercancia" value="${mercancia.descripcion}">
                                </center>
                            </td>
                        </tr>
                        ...
                        <td style="text-align: center; border: none; ">
                            <c:choose>
                                <c:when test="${importeTotal == 0}">
                                        ...
                                        w3-highway-red w3-hover-black w3-block" type="submit" value="Eliminar" disabled>
                                </c:when>
                                <c:otherwise>
                                        <input class="w3-button w3-round w3-text-white 
                                                w3-highway-red w3-hover-black w3-block" type="submit" value="Eliminar">
                                </c:otherwise>
                            </c:choose>                            
                        </td>
                    </tr>
        ...
        <div class="w3-container w3-row" style="width: 50%; margin-top: 2em">
            <div class="w3-half w3-container">
                <a href="/Boundless/stock" class="w3-button w3-round w3-text-white 
                    w3-highway-red w3-hover-black w3-block" style="font-size: large;  margin-right: 2em">Seguir comprando</a>
            </div>
            <div class="w3-half w3-container" style=" margin-bottom: 1em;">
                <c:choose>
                    <c:when test="${importeTotal == 0 || usuario == null}">
                        <a onClick="" class="w3-button w3-round w3-text-white 
                            w3-highway-red w3-hover-black w3-block" style="font-size: large; margin-right: 2em; filter: opacity(25%); 
                            cursor: not-allowed;">Proceder al pago</a>
                    </c:when>
                    <c:otherwise>
                        <a href="vistaPagar.jsp" class="w3-button w3-round w3-text-white 
                            w3-highway-red w3-hover-black w3-block" style="font-size: large;  margin-right: 2em">Proceder al pago</a>
                    </c:otherwise>
                </c:choose> 
            </div>
            <p id="merrorUsuario" style="display: none; font-weight: bold">Debe iniciar sesión para continuar</p>
            <c:if test="${usuario == null && importeTotal > 0}">
                <script>
                    $("#merrorUsuario").css("display", "inline");
                </script>
            </c:if>
        </div>
    </div>
