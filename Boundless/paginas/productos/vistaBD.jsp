...
<head>
    ...
    <meta name="descripcion" content="Recoge información sobre el juego Blue Destiny">

    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Blue Destiny</title>
    ...
    <script>
        ...
        function myFunction(xml) {
            ...
            //Primer juego
            var J = xmlDoc.getElementsByTagName("BD");
...
<body onload="loadDoc();" style="background-image: url(../../imagenes/bg2.jpg); background-position: bottom; background-repeat: no-repeat; width: 100%;">
    ...
    <div class="w3-animate-opacity" ALIGN=center>
        ...
        <span id="titulo" class="nombreJuego" style="color: #6981ac;"></span>
