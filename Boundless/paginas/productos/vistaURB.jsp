...
<head>
    ...
    <meta name="descripcion" content="Recoge información sobre el juego Ultimate Rap Battle">

    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Ultimate Rap Battle</title>
    ...
    <script>
        ...
        function myFunction(xml) {
            ...
            //Primer juego
            var J = xmlDoc.getElementsByTagName("URB");
...
<body onload="loadDoc();" style="background-image: url(../../imagenes/bg2.jpg); background-position: bottom; background-repeat: no-repeat; width: 100%;">
    ...
    <div class="w3-animate-opacity" ALIGN=center>
        ...
        <span id="titulo" class="nombreJuego" style="color: #c90b4a;"></span>
